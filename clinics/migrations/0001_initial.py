    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clinics', to='locations.country')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clinics_owned', to=settings.AUTH_USER_MODEL)),
                ('state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clinics', to='locations.state')),
            ],
            options={
                'verbose_name': 'clinic',
        ...
        migrations.AddField(
            model_name='clinic',
            name='members',
            field=models.ManyToManyField(related_name='clinics_joined', through='clinics.ClinicMembership', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='ClinicService',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=255)),
                ('service_cost', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('clinic_setting', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='working_days', to='clinics.clinicsetting')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invited_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clinic_invitation_made', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                ...
                'ordering': ['-created_at'],
                'constraints': [models.UniqueConstraint(fields=('clinic', 'email'), name='clinic_invitations_email_unique')],
            },
        ),
        migrations.AddIndex(
            model_name='clinicmembership',
            index=django.contrib.postgres.indexes.GinIndex(fields=['specializations'], name='membership_spec_gin_idx'),
        ),
        migrations.AddConstraint(
            model_name='clinicmembership',
            constraint=models.UniqueConstraint(fields=('clinic', 'user'), name='clinic_memberships_clinic_user_unique'),
        ),
        migrations.AddConstraint(
            model_name='clinicservice',
            constraint=models.UniqueConstraint(fields=('clinic', 'name'), name='clinic_services_name_unique'),
        ),
        migrations.AddConstraint(
            model_name='clinicworkingday',
            constraint=models.UniqueConstraint(fields=('clinic_setting', 'day_of_week'), name='unique_clinic_day'),
        ),
    ]
